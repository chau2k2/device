...
namespace device.IServices
{
    public interface IProducerService
    {
        ...
        Task<ActionResult<BaseResponse<Producer>>> UpdateProducer(int id, ProducerModel Upd);
        Task<ActionResult<BaseResponse<Producer>>> CreateProducer(ProducerModel cpr);
